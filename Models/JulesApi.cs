...
)
{
    public string? DisplayText =>
        ...
        (!string.IsNullOrEmpty(Description) && ProgressUpdated == null && PlanGenerated == null ? Description :
        (!string.IsNullOrEmpty(SessionFailed?.Reason) ? SessionFailed.Reason : null)))))));
